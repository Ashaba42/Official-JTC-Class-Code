...
#print(f"Four Barrel is located at {restaurant['address1']}, {restaurant['city']}, {restaurant['state']},{restaurant['zip_code']}")
...
fav_restaurants = {
    "Subway": ["1234 Wright St, NY 11233", "Tuna Sub", "9 AM - 9 PM"],
    "Lo Mein": ["5678 Bruce Rd, NY 10002", "Orange Chicken", "6 AM - 11 PM"],
    "BBQs": ["1122 Grand St, NY 11225", "Chicken Wings", "11 AM - 11 PM"]
}
...
#fav_restaurants['Subway': '5 AM - 11 PM']
...
details = fav_restaurants['Subway'][2]
old_hours = details[2]
print(old_hours)

fav_restaurants['Subway'][2] = '2-12 PM'
new_hours = fav_restaurants['Subway'][2]
print(new_hours )
...
'''
song = {'artist': 'Lauryn Hill', 'title': 'Everything Is Everything'}
...
add_song(my_playlist, {'artist': 'Ne-Yo', 'title': 'Superstar'})
add_song(my_playlist, {'artist': 'Micheal Jackson', 'title': 'Beat It'} )
display_playlist(my_playlist)
...
list_average = np.mean(monthly_plays)
print(list_average) 
print(np.mean(monthly_plays)) #best practice to use this version
